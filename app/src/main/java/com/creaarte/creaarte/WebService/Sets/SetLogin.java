...
public class SetLogin extends AsyncTask<String, String, ItemUserDate> {
    ...
    public SetLogin(Activity activity) {
    ...
    protected ItemUserDate doInBackground(String... params) {
        ...
        WebServiceClient client = new WebServiceClient(WebServiceClient.RequestMethod.POST, "setLogin");
        client.addTextParam("USRL_email", params[0]);
        client.addTextParam("USRL_passw", params[1]);
        client.addTextParam("USRL_ip_addr", params[2]);
        try {
